package br.com.brunogodoif.dataexporthub.converterservice.listeners;
...
public @interface StrConsumerCustomListener {
    ...
    // Adicione um novo atributo para especificar o modo de confirmação do offset
    //String ackMode() default "AUTO";
}